...
A principal representação é a classe, que funciona como um modelo para criar objetos. Uma das principais linguagens utilizadas é Java. Nela, uma classe é implementada utilizando a palavra `class`.
...
O código completo está no arquivo [Main.java](Main.java).
